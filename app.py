...
# =============================================================================
    ...
    if not fdf.empty:
        ...
        def calc_row(row):
            ...
            vals = [total, drop_str, oshime, rsi_str, er] + [score_strs.get(n, "") for n in item_names]
        ...
        col_names = ['スコア', '52w位置', '押し目', '過熱感', '決算'] + item_headers
        ...
        display_cols = (['順位', '記号', '銘柄', 'スコア', '52w位置', '押し目', '過熱感', '決算',
                         '次回決算日', '配当日']
                        + item_headers
                        + ['株価'])
